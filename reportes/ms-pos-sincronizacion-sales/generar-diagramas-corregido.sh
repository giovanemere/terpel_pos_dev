...
# Generar diagramas de arquitectura corregidos
...
plt.close()
print("✅ Diagrama arquitectura actual generado")
EOF
...
plt.close()
print("✅ Diagrama recursos limitados generado")
EOF
...
plt.close()
print("✅ Diagrama comparativo generado")
EOF

echo ""
echo "✅ Todos los diagramas de arquitectura generados exitosamente:"
ls -la "$DIRECTORIO_DIAGRAMAS"/*.png
